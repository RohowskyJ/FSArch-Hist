...
require $path2ROOT . 'login/common/FS_ConstLib.php';
...
initial_debug('POST','GET');
   ...
   if (is_file('Oeffi/VS_O_AR_List.php')) {
       ...
       echo "<a href='Oeffi/VS_O_AR_List.php' target='Biete-Suche'>Archiv- und Bibliotheks- Links</a>";
       echo "  </div>";  // Ende Feldname
   }
   
   if (is_file('Oeffi/VS_O_AN_List.php')) {
       ...
       echo "  </div>";  // Ende Feldname
       echo "<div class='Menu-Line'>"; // Beginn der Anzeige Feld-Name
       echo "<a href='Oeffi/VS_O_AN_List.php' target='Biete-Suche'>Biete- /Suche- Marktplatz, Adminstrativer Teil</a>";
       echo "</div>"; // Ende der Ausgabe- Einheit Feld
   }
   
   if (is_file('Oeffi/VS_O_BU_List.php')) {
       echo "<div class='Menu-Separator'>Buch Rezensionen</div>";
       echo "<div class='Menu-Line'>"; // Beginn der Einheit Ausgabe
       echo "Pflege der Buch Rezensionen";
       echo "  </div>";  // Ende Feldname
       echo "<div class='Menu-Line'>"; // Beginn der Anzeige Feld-Name
       echo "<a href='Oeffi/VS_O_BU_List.php' target='Bücher'>Buch- Rezensionen, Verwalten, Redigieren, Freischalten</a>";
       echo "</div>"; // Ende der Ausgabe- Einheit Feld
   }
   if (is_file('Oeffi/VS_O_DO_List.php')) {
       ...
       echo "  </div>";  // Ende Feldname
       echo "<div class='Menu-Line'>"; // Beginn der Anzeige Feld-Name
       echo "<a href='Oeffi/VS_O_DO_List.php' target='Doku'>Dokumentationen zum herunterladen</a>";
       echo "</div>"; // Ende der Ausgabe- Einheit Feld
   }

   if (is_file('Oeffi/VS_O_MU_List.php')) {
       echo "<div class='Menu-Separator'>Museumsdaten warten</div>";
       echo "<div class='Menu-Line'>"; // Beginn der Einheit Ausgabe
       echo "Pflege der Museumsliste ";
       echo "  </div>";  // Ende Feldname
       echo "<div class='Menu-Line'>"; // Beginn der Anzeige Feld-Name
       echo "<a href='Oeffi/VF_O_MU_List.php' target='Museen'>Museumsdatenwartung</a>";
       echo "</div>"; // Ende der Ausgabe- Einheit Feld
   }
   if (is_file('Oeffi/VS_O_PR_List.php')) {
       echo "<div class='Menu-Separator'>Presse- Ausschnitte</div>";
       echo "<div class='Menu-Line'>"; // Beginn der Einheit Ausgabe
       echo "Pflege der in der Presse veröffentlichen Artikel";
       echo "  </div>";  // Ende Feldname
       echo "<div class='Menu-Line'>"; // Beginn der Anzeige Feld-Name
       echo "<a href='Oeffi/VS_O_PR_List.php' target='Presse'>Presse-Informationen verwalten</a>";
       echo "</div>"; // Ende der Ausgabe- Einheit Feld
   }
   if (is_file('Oeffi/VS_O_TE_List.php')) {
       echo "<div class='Menu-Separator'>Terminplan  (Kalender)');</div>";
       echo "<div class='Menu-Line'>"; // Beginn der Einheit Ausgabe
       echo "Hier werden die Termine in den Kalender eingepflegt ";
       echo "  </div>";  // Ende Feldname
       echo "<div class='Menu-Line'>"; // Beginn der Anzeige Feld-Name
       echo "<a href='Oeffi/VS_O_TE_List.php' target='Terminplan'>Terminplan und Anmeldungs- Bearbeitung</a>";
       echo "</div>"; // Ende der Ausgabe- Einheit Feld
   }
   if (is_file('Oeffi/VS_O_ZT_List.php')) {
       echo "<div class='Menu-Separator'>Index von Feuerwehrzeitungen</div>";
       echo "<div class='Menu-Line'>"; // Beginn der Einheit Ausgabe
       echo "Eingabe und Pflege von Index für Feuerwehrzeitugen.";
       echo "  </div>";  // Ende Feldname
       echo "<div class='Menu-Line'>"; // Beginn der Anzeige Feld-Name
       echo "<a href='Oeffi/VS_O_ZT_List.php' target='ZT-Index'>Zeitungsindex</a>";
       echo "</div>"; // Ende der Ausgabe- Einheit Feld
   }
   
   echo  "<div class='Menu-Header'>Foto, Archiv und Inventar </div>";
   
   if (is_file('Foto/VS_O_FO_List.php')) {
       ...
       echo "  </div>";  // Ende Feldname
       echo "<div class='Menu-Line'>"; // Beginn der Anzeige Feld-Name
       echo "<a href='Foto/VS_FO_Ber_Verw.php?Act=1' target='Foto_Ber'>Foto, Video und Berichte- Verwaltung</a>";
       echo "</div>"; // Ende der Ausgabe- Einheit Feld
   }
   if (is_file('Arch/VS_A_AN_List.php')) {
       ...
       echo "</div>";
       echo "<div class='Menu-Line'>"; // Beginn der Anzeige Feld-Name
       echo "<a href='Arch/VS_A_Archiv_Verw.php' target='A-Verwaltung'>Archivalienverwaltung und erweiterte Archivordnung </a>";
       echo "</div>"; // Ende der Ausgabe- Einheit Feld
   }
   if (is_file('INV/VS_O_AN_List.php')) {
       echo "<div class='Menu-Line'>"; // Beginn der Einheit Ausgabe
       echo "<div class='Menu-Separator'>Verwaltung aller nicht unter Dokumente fallenden Gegenstände.";
       echo "  </div>";  // Ende Feldname
       echo "<div class='Menu-Line'>"; // Beginn der Anzeige Feld-Name
       echo "<a href='INV/VS_I_Inv_Verw.php' target='Inventar'>Inventar- Verwaltung</a>";
       echo "</div>"; // Ende der Ausgabe- Einheit Feld
   }
