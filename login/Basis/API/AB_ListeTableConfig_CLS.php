...
ini_set('error_log', "AB_ListeTableConfig_php-error.log.txt");

class AB_ListeTableConfig {
    /**
    ...
    private static string $logFile = "AB_ListeTableConfig_debug.log.txt";
    ...
    public static function getColumns(string $listType, PDO $pdo): array {
        ...
        $colsByTable = $meta->getColumnsForTables(["fv_abk"]);
