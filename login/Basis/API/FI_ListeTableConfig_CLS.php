...
class FI_ListeTableConfig {
    ...
    private static string $logFile = "FI_ListeTableConfig_debug.log.txt";
    ...
    public static function getColumns(string $listType, PDO $pdo): array {
        ...
        switch ($listType) {     
            case "Alle":
            default: 
                $showCols = ["fi_id", "fi_abk", "fi_name", "fi_ort", "fi_vorgaenger",  "fi_funct", "fi_inet"];
