...
if (userHasRole('ADM-MB')) {  // Ist Benutzer berechtigt?
    ...
    echo "<div class='Menu-Line'>"; // Beginn der Einheit Ausgabe
    echo "<a href='VF_MB_List.php' target='M Bez.-Verwaltung'>Beitrags- Eingang</a> <br>";
    echo "<a href='VF_MB_List_nL.php' target='M Bez.-Verwaltung'>Beitrags- Eingang - NEUES FORMAT</a>";
    echo "  </div>";  // Ende Feldname
}
