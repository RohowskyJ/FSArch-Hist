...
ini_set('error_log', __DIR__ . '/VS_UM_List_php-error.log.txt');
# var_dump($_SERVER);
...
$_SESSION[$module]['Inc_Arr'][] = "VS_UnterstList.php"; 
...
$NeuRec = " <a href='VS_UnterstEdit.php?ID=0' >Neuen Unterstützer eingeben</a>";
# ===========================================================================================
